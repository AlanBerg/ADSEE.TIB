...
# Count the number of rows of the badly named sample data.table
no.row <- nrow(sample)
...
# (A) for 1 sample
kwic(tokens(sample$JobBody[rows[1]]),pattern = "Financial", window = 3, valuetype = "fixed")
